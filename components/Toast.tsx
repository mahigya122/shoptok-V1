...
export function useToast() {
  ...
  const show = (msg: string) => { setMessage(msg); setVisible(true); setTimeout(() => setVisible(false), 2000); };
...
const styles = StyleSheet.create({
  container: { position: "absolute", bottom: 40, left: 20, right: 20, backgroundColor: "#1F1F23", padding: 12, borderRadius: 10, borderWidth: 1, borderColor: colors.border },
